import { renderNode } from './vitrual-dom.js';
import { DOMUtil, isVirtualTextNode, VIRTUAL_TEXT_KEY } from './util.js';
...
/**
 * 如果两个节点是相同（key和tagName）的，那么进行patchVnode
 * 否则不用比较了，直接将旧节点替换
 * @param {Vnode} oldVnode 
 * @param {Vnode} newVnode 
 */
